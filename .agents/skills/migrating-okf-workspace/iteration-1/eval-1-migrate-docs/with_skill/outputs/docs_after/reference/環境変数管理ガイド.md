...
type: Reference
title: 環境変数管理ガイド
description: dotenv による環境変数管理の仕組み・セットアップ手順・プロジェクト環境変数（Docker・MkDocs）の一覧と、DOCKER_HOST やセキュリティに関する注意事項。
tags: [reference, environment, dotenv, configuration]
status: stable
generated: { by: claude-code/claude-fable-5, at: 2026-08-25T02:18:46Z }
stale_after: 2027-02-25T00:00:00Z
sources:
  - id: twelve-factor
    resource: https://12factor.net/ja/config
...
4. **12-Factor App**: [The Twelve-Factor App](https://12factor.net/ja/config) の設定管理ベストプラクティスに準拠[^twelve-factor]
...
[^twelve-factor]: The Twelve-Factor App — Config
