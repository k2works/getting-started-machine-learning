...
| [011](011-clojure-ml-libraries.md) | Clojure 版のライブラリに Clojure CLI・clojure.test・clj-kondo・cljfmt・cloverage・Tribuo 4.3・data.csv・Ring を採用し、GPL-3.0 の Smile を使わない | 提案中 |
