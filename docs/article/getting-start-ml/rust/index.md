...
| [rand](https://docs.rs/rand/) | 乱数（訓練データとテストデータの分割） | [第 2 章](02-data-preprocessing-and-triangulation.md) |
| [linfa](https://rust-ml.github.io/linfa/) | 決定木・回帰・ロジスティック回帰・K-means・主成分分析・評価指標・交差検証 | [第 3 章](03-decision-tree-and-obvious-implementation.md) |
| [ndarray](https://docs.rs/ndarray/) | 行列 | [第 7 章](07-linear-regression.md) |
| [serde](https://serde.rs/)・serde_json | 学習済みモデルの保存 | [第 8 章](08-classification-and-preprocessing-pipeline.md) |
| [encoding_rs](https://docs.rs/encoding_rs/) | Shift_JIS の CSV | [第 9 章](09-feature-engineering.md) |
| [axum](https://docs.rs/axum/)・tokio | 予測 API | [第 15 章](15-machine-learning-api-and-module-design.md) |
